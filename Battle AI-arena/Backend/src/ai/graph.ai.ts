...
const judgeNode: GraphNode<typeof state> = async (state)=>{
    ...
    const judge = createAgent({
        ...
        systemPrompt:`you are a judge tasked with evaluting two solutions generated by different AI Models. Please porvide the score out of 10 for each solution, along with your reasoning for the score`
    })
